...
import { AlertTriangle, Film, Home, RefreshCw } from "lucide-react";
...
export default function AnimeError({
  ...
  return (
    <div className="container mx-auto flex min-h-[calc(100vh-12rem)] flex-col items-center justify-center px-4 text-center">
      ...
      <h2 className="mb-4 text-2xl font-bold">Gagal Memuat Anime</h2>
      <p className="text-muted-foreground mb-4 max-w-md text-lg">
        Terjadi kesalahan saat mengambil data anime. Server mungkin sedang sibuk, silakan coba lagi.
      </p>
      {error.message && (
