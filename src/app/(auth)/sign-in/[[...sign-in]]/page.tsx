      ...
      <div className="max-w-md w-full space-y-6 text-center">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Clerk authentication is not yet configured. You can still use the app
            with local storage for bookmarks and history.
          </p>
        </div>
        <div className="bg-muted/50 rounded-lg p-4 text-left text-sm">
          <p className="font-medium text-foreground mb-2">To enable authentication:</p>
